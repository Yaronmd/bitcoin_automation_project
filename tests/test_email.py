...
def test_send_email_success(
    mock_load_dotenv, mock_getenv, mock_email_sender_class, mock_get_max_bitcoin
):
    ...
    mock_email_sender_class.assert_called_once_with(
        email_sender, email_password, email_recevier
    )
    ...
    mock_email_sender.send_email_with_attachment.assert_called_once_with(
        "Bitcoin automation", body=body, file_path=plot_file
    )
